	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (OrderItem oi : utility.getCustomerOrders()) {
				...
				pw.print("<input type='hidden' name='orderPrice' value='" + calculatePrice(oi) + "'>");
				pw.print("<input type='hidden' name='orderName' value='" + oi.getName() + "'>");
				pw.print("Product Price:</td><td>" + calculatePrice(oi));
				pw.print("</td></tr>");
			}
			pw.print("<tr><td>");
			...
			pw.print("<input type='submit' name='submit' value='submit' class='btnbuy'>");
