	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Map.Entry<String, Laptop> entry : hm.entrySet()) {
			...
			pw.print("<li><form method='post' action='Cart'>" + "<input type='hidden' name='name' value='"
					...
					+ "<input type='submit' class='btnbuy' name='BuyBtn' value='Buy with 1yr Care $34.99'>"
					+ "<input type='submit' class='btnbuy' name='BuyBtn' value='Buy with 2yr Care $69.99'>"
					+ "<input type='submit' class='btnbuy' name='BuyBtn' value='Buy with 3yr Care $99.99'></form></li>");
			pw.print("</ul></div></td>");
			if (i % 3 == 0 || i == size)
				pw.print("</tr>");
			i++;
